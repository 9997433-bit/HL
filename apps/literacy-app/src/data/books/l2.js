    ...
    pages: [
      {
        ...
        scene: [
          { e: '⛰️', x: 20, y: 44, s: 1.5 },
          { e: '🐴', x: 40, y: 72, s: 1.7 },
          { e: '🌊', x: 72, y: 86, s: 1.3, m: 'drift' },
          { e: '🌿', x: 84, y: 70, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '小鼠说水很深',
        scene: [
          { e: '🐿️', x: 30, y: 66, s: 1.2, m: 'float' },
          { e: '🐴', x: 58, y: 72, s: 1.4 },
          { e: '💧', x: 78, y: 60, s: 0.8, m: 'float' },
          { e: '🌊', x: 46, y: 88, s: 1.3, m: 'drift' }
        ]
      },
      {
        ...
        scene: [
          { e: '🐄', x: 30, y: 68, s: 1.7 },
          { e: '🐴', x: 62, y: 74, s: 1.3 },
          { e: '🌾', x: 84, y: 78, s: 1.1, m: 'sway' },
          { e: '🌊', x: 46, y: 90, s: 1.2, m: 'drift' }
        ]
      },
      {
        emoji: '🤔', text: '小马不明白：为什么一个说深，一个说浅？', p: 'xiǎo mǎ bù míng bai: wèi shén me yī gè shuō shēn, yī gè shuō qiǎn?',
        sceneBg: 'field',
        sceneAlt: '小马不明白，一个说深，一个说浅',
        scene: [
          { e: '❓', x: 52, y: 38, s: 1.2, m: 'float' },
          { e: '🐿️', x: 22, y: 70, s: 1, m: 'float' },
          { e: '🐄', x: 78, y: 72, s: 1.3 },
          { e: '🐴', x: 50, y: 82, s: 1.5 }
        ]
      },
      ...
      },
      {
        ...
        sceneBg: 'water',
        sceneAlt: '小马下了水，水到他的腿',
        scene: [
          { e: '🐴', x: 46, y: 62, s: 1.6 },
          { e: '💧', x: 66, y: 76, s: 0.9, m: 'float' },
          { e: '🫧', x: 78, y: 66, s: 0.7, m: 'float' },
          { e: '🌊', x: 28, y: 86, s: 1.3, m: 'drift' }
        ]
      },
      {
        ...
        scene: [
          ...
          { e: '🐴', x: 54, y: 66, s: 1.7, m: 'drift' },
          { e: '🌊', x: 26, y: 86, s: 1.3, m: 'drift' },
    ...
    pages: [
      {
        ...
        sceneAlt: '风来了',
        scene: [
          { e: '💨', x: 30, y: 34, s: 1.5, m: 'drift' },
          { e: '☁️', x: 70, y: 26, s: 1.2, m: 'drift' },
          { e: '🌳', x: 26, y: 80, s: 1.5, m: 'sway' },
          { e: '🍃', x: 62, y: 62, s: 0.9, m: 'drift' }
        ]
      },
      {
        ...
        sceneAlt: '树上的叶飞了一地',
        scene: [
          { e: '🌳', x: 30, y: 58, s: 1.8, m: 'sway' },
          { e: '🍃', x: 58, y: 62, s: 1, m: 'drift' },
          { e: '🍃', x: 74, y: 78, s: 0.9, m: 'drift' },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        scene: [
          { e: '🎏', x: 62, y: 40, s: 1.3, m: 'drift' },
          { e: '💨', x: 24, y: 44, s: 1.2, m: 'drift' },
          { e: '🌳', x: 84, y: 66, s: 1.3, m: 'sway' },
          { e: '🧒', x: 40, y: 82, s: 1.5 }
        ]
      },
      {
        ...
        sceneAlt: '天上的云走很快',
        scene: [
          { e: '☁️', x: 24, y: 24, s: 1.3, m: 'drift' },
          { e: '☁️', x: 56, y: 34, s: 1.1, m: 'drift' },
          { e: '☁️', x: 82, y: 44, s: 0.9, m: 'drift' },
          { e: '🌳', x: 34, y: 86, s: 1.3, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '风大了，我的帽也飞了',
        scene: [
          { e: '🌀', x: 26, y: 32, s: 1.4, m: 'drift' },
          { e: '🧢', x: 62, y: 42, s: 1.2, m: 'drift' },
          { e: '🌳', x: 84, y: 70, s: 1.3, m: 'sway' },
          { e: '🧒', x: 40, y: 84, s: 1.4 }
        ]
      },
      {
      ...
      },
      {
        ...
        sceneAlt: '风停了，天又亮了',
        scene: [
          { e: '☀️', x: 78, y: 20, s: 1.4, m: 'float' },
          { e: '☁️', x: 28, y: 28, s: 1, m: 'drift' },
          { e: '🌳', x: 24, y: 78, s: 1.4 },
          { e: '🏠', x: 62, y: 84, s: 1.3 }
        ]
      }
    ...
    pages: [
      {
        ...
        sceneAlt: '早上开门，地上都是雪',
        scene: [
          { e: '❄️', x: 30, y: 26, s: 0.9, m: 'float' },
          { e: '❄️', x: 72, y: 36, s: 0.8, m: 'float' },
          { e: '🚪', x: 46, y: 62, s: 1.7 },
          { e: '🏠', x: 78, y: 76, s: 1.3 }
        ]
      },
      {
        ...
        sceneBg: 'snow',
        sceneAlt: '树是白的，屋顶也是白的',
        scene: [
          { e: '❄️', x: 60, y: 28, s: 0.8, m: 'float' },
          { e: '🌲', x: 22, y: 66, s: 1.7 },
          { e: '🏠', x: 62, y: 78, s: 1.5 },
          { e: '🌲', x: 86, y: 84, s: 1.1 }
        ]
      },
      {
        ...
        sceneAlt: '妈妈给我一顶帽和厚衣',
        scene: [
          { e: '🧢', x: 48, y: 42, s: 1.2, m: 'float' },
          { e: '🧣', x: 74, y: 62, s: 1.2, m: 'sway' },
          { e: '👩', x: 70, y: 78, s: 1.4 },
          { e: '🧒', x: 34, y: 82, s: 1.4 }
        ]
      },
      ...
      },
      {
        ...
        sceneAlt: '雪人有眼，也有鼻',
        scene: [
          { e: '👀', x: 44, y: 42, s: 1, m: 'float' },
          { e: '👃', x: 62, y: 50, s: 0.9, m: 'float' },
          { e: '⛄', x: 52, y: 74, s: 2 },
          { e: '❄️', x: 84, y: 30, s: 0.8, m: 'float' }
        ]
      },
      {
        ...
        sceneAlt: '雪还在下，我们都笑了',
        scene: [
          { e: '❄️', x: 24, y: 24, s: 0.9, m: 'float' },
          { e: '❄️', x: 66, y: 34, s: 0.8, m: 'float' },
          { e: '⛄', x: 76, y: 76, s: 1.3 },
          { e: '😄', x: 40, y: 80, s: 1.6, m: 'float' }
        ]
      },
      {
        emoji: '🍵', text: '回到屋里，一杯热茶真暖。', p: 'huí dào wū lǐ, yī bēi rè chá zhēn nuǎn.',
        sceneBg: 'room',
        sceneAlt: '回到屋里，一杯热茶真暖',
        scene: [
          { e: '♨️', x: 52, y: 40, s: 1, m: 'float' },
          { e: '🍵', x: 50, y: 62, s: 1.6 },
          { e: '🧒', x: 26, y: 80, s: 1.4 },
          { e: '🪑', x: 80, y: 86, s: 1.1 }
        ]
    ...
    pages: [
      ...
      },
      {
        ...
        scene: [
          ...
          { e: '🐰', x: 30, y: 68, s: 1.5 },
          { e: '🌱', x: 58, y: 82, s: 1, m: 'sway' },
          { e: '🌱', x: 76, y: 88, s: 0.9, m: 'sway' }
        ]
      },
      {
        emoji: '💧', text: '每天早上，他给菜苗浇水。', p: 'měi tiān zǎo shang, tā gěi cài miáo jiāo shuǐ.',
        sceneBg: 'field',
        sceneAlt: '每天早上，他给菜苗浇水',
        scene: [
          { e: '💧', x: 58, y: 56, s: 1, m: 'float' },
          { e: '🐰', x: 30, y: 70, s: 1.5 },
          { e: '🌱', x: 62, y: 80, s: 1.1, m: 'sway' },
      ...
      },
      {
        ...
        sceneBg: 'field',
        sceneAlt: '过了一个月，菜都长大了',
        scene: [
          { e: '🥬', x: 40, y: 68, s: 1.6, m: 'float' },
          { e: '🥬', x: 66, y: 80, s: 1.3 },
          { e: '🐰', x: 22, y: 82, s: 1.3 },
          { e: '🌿', x: 84, y: 88, s: 1, m: 'sway' }
        ]
    ...
    pages: [
      {
        ...
        sceneAlt: '小蚁在路上找到一个米',
        scene: [
          { e: '🌾', x: 80, y: 66, s: 1.2, m: 'sway' },
          { e: '🐜', x: 46, y: 78, s: 1.1, m: 'drift' },
          { e: '🪨', x: 22, y: 84, s: 1.1 },
          { e: '🌿', x: 66, y: 90, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '他把米放到背上',
        scene: [
          { e: '🎒', x: 52, y: 68, s: 1, m: 'float' },
          { e: '🐜', x: 46, y: 80, s: 1.2, m: 'drift' },
          { e: '🪨', x: 80, y: 82, s: 1.1 },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '米不重，小蚁走很快',
        scene: [
          { e: '🌱', x: 78, y: 70, s: 1, m: 'sway' },
          { e: '🐜', x: 40, y: 80, s: 1.2, m: 'drift' },
          { e: '🌿', x: 22, y: 86, s: 1, m: 'sway' },
          { e: '🪨', x: 66, y: 90, s: 1 }
        ]
      },
      {
        ...
        sceneAlt: '走到半路，雨来了',
        scene: [
          { e: '🌧️', x: 56, y: 28, s: 1.5, m: 'drift' },
          { e: '💧', x: 76, y: 54, s: 0.8, m: 'float' },
          { e: '🐜', x: 40, y: 80, s: 1.1, m: 'drift' },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '小蚁在一片叶下停了停',
        scene: [
          { e: '💧', x: 74, y: 42, s: 0.8, m: 'float' },
          { e: '🍃', x: 46, y: 62, s: 1.6, m: 'sway' },
          { e: '🐜', x: 48, y: 80, s: 1.1 },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        scene: [
          ...
          { e: '🍃', x: 26, y: 62, s: 1, m: 'drift' },
          { e: '🐜', x: 50, y: 80, s: 1.2, m: 'drift' },
          { e: '🌿', x: 76, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        emoji: '🏠', text: '到家了，妈妈说：你真勤快！', p: 'dào jiā le, mā ma shuō: nǐ zhēn qín kuài!',
        sceneBg: 'field',
        sceneAlt: '到家了，妈妈说你真勤快',
        scene: [
          { e: '❤️', x: 50, y: 34, s: 1, m: 'float' },
          { e: '🏠', x: 68, y: 62, s: 1.6 },
          { e: '🐜', x: 34, y: 80, s: 1.1 },
          { e: '🐜', x: 50, y: 88, s: 1, m: 'drift' }
        ]
      }
    ]
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        sceneBg: 'room',
        sceneAlt: '我开门，婆婆手里有一袋糕',
        scene: [
          { e: '🚪', x: 22, y: 56, s: 1.5 },
          { e: '🍰', x: 66, y: 62, s: 1.1, m: 'float' },
          { e: '👵', x: 68, y: 78, s: 1.5 },
          { e: '🧒', x: 38, y: 82, s: 1.3 }
        ]
      },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        sceneAlt: '小熊的脸红了',
        scene: [
          { e: '🐝', x: 78, y: 44, s: 0.9, m: 'float' },
          { e: '😳', x: 48, y: 62, s: 1.7, m: 'float' },
          { e: '🐻', x: 46, y: 82, s: 1.4 },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '小熊说我给你们种花',
        scene: [
          { e: '🐝', x: 76, y: 42, s: 0.9, m: 'float' },
          { e: '🌸', x: 62, y: 70, s: 1.2, m: 'sway' },
          { e: '🐻', x: 36, y: 76, s: 1.6 },
          { e: '🌱', x: 78, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        scene: [
          { e: '⛰️', x: 22, y: 44, s: 1.6 },
          { e: '🌸', x: 42, y: 72, s: 1.3, m: 'sway' },
          { e: '🌼', x: 68, y: 80, s: 1.2, m: 'sway' },
          { e: '🌺', x: 84, y: 88, s: 1.1, m: 'sway' }
        ]
      },
      {
        emoji: '🍯', text: '蜂做了好多蜜，也分给小熊。', p: 'fēng zuò le hǎo duō mì, yě fēn gěi xiǎo xióng.',
        sceneBg: 'field',
        sceneAlt: '蜂做了好多蜜，也分给小熊',
        scene: [
          { e: '🐝', x: 70, y: 40, s: 1, m: 'float' },
          { e: '🍯', x: 52, y: 62, s: 1.4, m: 'float' },
          { e: '🐻', x: 34, y: 78, s: 1.5 },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        scene: [
          { e: '🌳', x: 22, y: 60, s: 1.4 },
          { e: '🏃', x: 52, y: 76, s: 1.7, m: 'drift' },
          { e: '👟', x: 76, y: 88, s: 1 },
          { e: '🌿', x: 84, y: 74, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        scene: [
          { e: '🧒', x: 38, y: 66, s: 1.5 },
          { e: '💧', x: 62, y: 70, s: 0.9, m: 'float' },
          { e: '👟', x: 58, y: 84, s: 1.1 },
          { e: '🌊', x: 26, y: 90, s: 1.3, m: 'drift' }
        ]
      },
      {
      ...
      },
      {
        ...
        sceneBg: 'room',
        sceneAlt: '回家后，我洗了鞋，也洗了脚',
        scene: [
          { e: '🧼', x: 66, y: 56, s: 1.2, m: 'float' },
          { e: '👟', x: 44, y: 68, s: 1.3 },
          { e: '🦶', x: 70, y: 78, s: 1.1 },
          { e: '🧒', x: 26, y: 82, s: 1.4 }
        ]
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        sceneAlt: '小红去追球',
        scene: [
          { e: '⚽', x: 76, y: 60, s: 1.1, m: 'drift' },
          { e: '🏃', x: 44, y: 76, s: 1.7, m: 'drift' },
          { e: '🌳', x: 20, y: 62, s: 1.3 },
          { e: '🌿', x: 62, y: 90, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        scene: [
          { e: '🌳', x: 60, y: 56, s: 2 },
          { e: '🍃', x: 36, y: 62, s: 0.9, m: 'drift' },
          { e: '⚽', x: 66, y: 82, s: 1.2 },
          { e: '🌿', x: 22, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        scene: [
          { e: '🐔', x: 42, y: 70, s: 1.6 },
          { e: '🥚', x: 64, y: 82, s: 1, m: 'float' },
          { e: '🌾', x: 22, y: 84, s: 1.1, m: 'sway' },
          { e: '🌿', x: 84, y: 90, s: 1, m: 'sway' }
        ]
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        sceneAlt: '小猫下不来，在树上哭',
        scene: [
          { e: '😿', x: 58, y: 50, s: 1.4, m: 'float' },
          { e: '🌳', x: 56, y: 70, s: 2 },
          { e: '🍃', x: 30, y: 62, s: 0.9, m: 'drift' },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneBg: 'field',
        sceneAlt: '爸爸走到树下，举手要抱他',
        scene: [
          { e: '🐱', x: 60, y: 48, s: 1.1 },
          { e: '🌳', x: 62, y: 66, s: 1.8 },
          { e: '👨', x: 34, y: 78, s: 1.7 },
          { e: '🌿', x: 16, y: 90, s: 1, m: 'sway' }
        ]
      },
      {
        emoji: '🤲', text: '小猫跳下来，爸爸抱好他。', p: 'xiǎo māo tiào xià lái, bà ba bào hǎo tā.',
        sceneBg: 'field',
        sceneAlt: '小猫跳下来，爸爸抱好他',
        scene: [
          { e: '🌳', x: 78, y: 58, s: 1.5 },
          { e: '🐱', x: 46, y: 66, s: 1.3, m: 'float' },
          { e: '👨', x: 42, y: 82, s: 1.7 },
      ...
      },
      {
        ...
        sceneBg: 'field',
        sceneAlt: '小猫说以后我不上这么高的树',
        scene: [
          { e: '🌳', x: 80, y: 56, s: 1.4 },
          { e: '😺', x: 46, y: 66, s: 1.5, m: 'float' },
          { e: '👨', x: 68, y: 80, s: 1.4 },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      }
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        sceneBg: 'room',
        sceneAlt: '弟弟说我找不到我的小熊',
        scene: [
          { e: '🧸', x: 54, y: 52, s: 1.2, m: 'float' },
          { e: '👶', x: 70, y: 78, s: 1.4 },
          { e: '🧒', x: 30, y: 80, s: 1.4 },
          { e: '🪑', x: 84, y: 88, s: 1 }
        ]
      ...
      },
      {
        ...
        sceneBg: 'room',
        sceneAlt: '弟弟不哭了，他抱好小熊笑了',
        scene: [
          { e: '❤️', x: 50, y: 32, s: 1, m: 'float' },
          { e: '🧸', x: 66, y: 62, s: 1.1, m: 'float' },
          { e: '😄', x: 40, y: 64, s: 1.3, m: 'float' },
          { e: '👶', x: 52, y: 82, s: 1.6 }
        ]
      }
    ]
    ...
    pages: [
      {
        ...
        sceneBg: 'sky',
        sceneAlt: '春天到了，小燕从远方来',
        scene: [
          { e: '☀️', x: 82, y: 20, s: 1, m: 'float' },
          { e: '☁️', x: 26, y: 26, s: 1.1, m: 'drift' },
          { e: '🐦', x: 56, y: 36, s: 1.3, m: 'drift' },
          { e: '🌳', x: 34, y: 84, s: 1.3 }
        ]
      },
      {
        ...
        sceneAlt: '小燕在我家的檐下做家',
        scene: [
          { e: '🐦', x: 62, y: 44, s: 1.1, m: 'float' },
          { e: '🏠', x: 56, y: 66, s: 1.9 },
          { e: '🌳', x: 22, y: 70, s: 1.4 },
          { e: '🌿', x: 80, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '他一次一次拿来草和泥',
        scene: [
          { e: '🐦', x: 52, y: 42, s: 1.2, m: 'drift' },
          { e: '🌾', x: 76, y: 66, s: 1.1, m: 'sway' },
          { e: '🏠', x: 40, y: 72, s: 1.6 },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '过了几天，家里有了蛋',
        scene: [
          { e: '🥚', x: 52, y: 44, s: 0.9, m: 'float' },
          { e: '🐦', x: 70, y: 50, s: 1, m: 'float' },
          { e: '🏠', x: 46, y: 70, s: 1.7 },
          { e: '🌳', x: 84, y: 78, s: 1.2 }
        ]
      },
      {
        ...
        sceneBg: 'field',
        sceneAlt: '又过了几天，小燕有了娃',
        scene: [
          { e: '🐣', x: 50, y: 44, s: 1, m: 'float' },
          { e: '🐦', x: 68, y: 50, s: 1, m: 'float' },
          { e: '🏠', x: 44, y: 70, s: 1.7 },
          { e: '🌳', x: 84, y: 76, s: 1.2 }
        ]
      },
      {
        ...
        sceneAlt: '燕妈妈天天去找虫',
        scene: [
          { e: '🐦', x: 54, y: 40, s: 1.3, m: 'drift' },
          { e: '🐛', x: 74, y: 70, s: 0.9, m: 'sway' },
          { e: '🌳', x: 24, y: 66, s: 1.5 },
          { e: '🌿', x: 46, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        emoji: '😄', text: '我在窗前看，一天也看不完。', p: 'wǒ zài chuāng qián kàn, yī tiān yě kàn bù wán.',
        sceneBg: 'room',
        sceneAlt: '我在窗前看，一天也看不完',
        scene: [
          { e: '🐦', x: 74, y: 34, s: 1, m: 'float' },
          { e: '🪟', x: 58, y: 50, s: 1.8 },
          { e: '🧒', x: 30, y: 78, s: 1.5 },
          { e: '🪑', x: 78, y: 88, s: 1.1 }
        ]
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        scene: [
          { e: '🌳', x: 30, y: 56, s: 1.9 },
          { e: '🌸', x: 60, y: 74, s: 1.2, m: 'sway' },
          { e: '🌼', x: 80, y: 82, s: 1.1, m: 'sway' },
          { e: '🌿', x: 20, y: 88, s: 1, m: 'sway' }
        ]
      },
      {
        ...
        sceneAlt: '池里有鸭，鸭在水上',
        scene: [
          { e: '🦆', x: 44, y: 66, s: 1.5, m: 'sway' },
          { e: '🦆', x: 70, y: 76, s: 1.1, m: 'sway' },
          { e: '🌊', x: 26, y: 86, s: 1.3, m: 'drift' },
          { e: '🌿', x: 86, y: 68, s: 1, m: 'sway' }
        ]
      },
      {
      ...
      },
      {
        ...
        sceneBg: 'field',
        sceneAlt: '妈妈拿来苹果，一人一个',
        scene: [
          { e: '🍎', x: 52, y: 60, s: 1.3, m: 'float' },
          { e: '👩', x: 70, y: 76, s: 1.4 },
          { e: '🧒', x: 32, y: 80, s: 1.3 },
          { e: '🧺', x: 52, y: 90, s: 1.1 }
        ]
