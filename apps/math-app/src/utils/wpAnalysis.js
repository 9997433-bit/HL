 ...
 *
 * 公式推导管「每道题都有剖析」，手写剖析（ROUND17_H4 / ROUND18_H5 / ROUND19_H5，
 * 见 data/word-problem-explains.js）管「这道题讲得像老师」：查得到手写就整条顶掉
 * 公式那句放之四海皆准的话，查不到就照旧走公式，两边都不缺步。
 */
import { explainOf, ROUND17_H4, ROUND18_H5, ROUND19_H5 } from '@/data/word-problem-explains.js'
...
export { ROUND17_H4, ROUND18_H5, ROUND19_H4, ROUND19_H5 }
...
const CAPTIONS = {
  ...
  '×': '几条一样长的接在一起，看看一共有多长。',
  // 等分除问「一段多长」，包含除问「剪得出几段」，图上是同一件事，说法两头都留着
  '÷': '把长的那条平均剪开：要么看剪得出几段，要么看一段有多长。',
}
